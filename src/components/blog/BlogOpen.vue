    ...
    <el-timeline-item v-for="blog in blogList" :key="blog.blogId"
      ...
      <el-card shadow="hover" style="margin-right: 30px">
        <el-row>
          ...
          <el-col :span="6">
            <el-space direction="horizontal" style="margin-top: 25%">
              <el-button v-show="!isOther" type="primary" @click="router.push({path: '/blog', query: {blogId: blog.blogId}})"> 编辑 </el-button>
              <el-button v-show="!isOther" type="danger" @click="deleteBlog(blog.blogId)"> 删除 </el-button>
              <el-button type="info" @click="router.push({path: '/show', query: {blogId: blog.blogId}})"> 查看 </el-button>
            </el-space>
          </el-col>
        </el-row>
      </el-card>
